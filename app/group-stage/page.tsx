...
export default function GroupStagePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl shadow-2xl p-8 overflow-x-auto border-2 border-primary/10 animate-slide-up">
        <table className="w-full">
          <thead>
            <tr className="border-b-2 border-primary/20">
              <th className="text-left py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Место</th>
              <th className="text-left py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Никнейм</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Сыграно</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Осталось</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Победы</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Ничьи</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Поражения</th>
              <th className="text-center py-4 px-4 text-primary font-bold text-sm uppercase tracking-wider">Очки</th>
            </tr>
          </thead>
          <tbody>
